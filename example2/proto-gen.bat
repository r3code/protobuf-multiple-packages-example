...
pushd .
protoc -I. --go_out=plugins=grpc:. mycompany\example2proto\users\*.proto
protoc -I. --go_out=plugins=grpc:. mycompany\example2proto\auth\*.proto
protoc -I. --go_out=plugins=grpc:. mycompany\example2proto\*.proto
popd
